...
import { alertModal, formatGender, URLJoin } from "src/utils";
import {
  TalkTicketJson,
  TalkTicketJsonIoTs,
  TalkTicketKey,
      ...
      case "a" /* 失恋の悩み */:
        if (isSpeaker) {
          ...
          return [
            "悩みやモヤモヤを？",
            "力になってあげたいことはなんですか？",
            "励ますことができるかもしれない、失恋した経験があるから共感したい、なんでも大丈夫です！",
          ];
        }
      case "b" /* 片想いの悩み */:
        if (isSpeaker) {
          ...
          return [
            "悩みやモヤモヤを？",
            "力になってあげたいことはなんですか？",
            "好きな人へのアプローチでアドバイスできるかもしれない、片想いの悩みで共感したい、なんでも大丈夫です！",
          ];
        }
      case "c" /* アルバイトの悩み */:
        if (isSpeaker) {
          ...
          return [
            "悩みやモヤモヤを？",
            "力になってあげたいことはなんですか？",
            "経験を元にアドバイスできるかもしれない、自分も悩んだことがあるからこそ共感したい、なんでも大丈夫です！",
          ];
        }
      case "d" /* 就職の悩み */:
        if (isSpeaker) {
      ...
      case "e" /* 夢・目標の悩み */:
        if (isSpeaker) {
          return [
            "悩みやモヤモヤを？",
            "悩んでることはなんですか？",
            "やりたいことが分からない、こういうことを挑戦してみたい、軽く話しを聞いてもらいたいなんでも大丈夫です！",
          ];
        } else {
          return [
            "悩みやモヤモヤを？",
            "力になってあげたいことはなんですか？",
            "今は目標があるからこそ何かアドバイスできるかもしれない、やりたいことを一緒に探したい、なんでも大丈夫です！",
          ];
        }
      case "f" /* 人間関係全般の悩み */:
        if (isSpeaker) {
