...
export const CreatedRoomTemplate: React.FC = () => {
        ...
        <Block  row style={styles.leftMessageContainer}>
          ...
          <Block>
            <Block style={styles.leftMessage}>
              <Text size={14} color={COLORS.BLACK} numberOfLines={2} ellipsizeMode="tail">おめでとう！🎉ルームの作成が完了したよ！</Text>
            </Block>
        ...
        <Block  row style={styles.leftMessageContainer}>
          ...
          <Block>
            <Block  center style={styles.leftMessage}>
              <Text size={14} color={COLORS.BLACK} numberOfLines={2} ellipsizeMode="tail">あとは話しを聞いてくれる人がルームに入るまで待ちましょう！</Text>
            </Block>
            <Text size={12} color={COLORS.LIGHT_GRAY} style={styles.textLineHeight}>21:23</Text>
          </Block>
        </Block>
