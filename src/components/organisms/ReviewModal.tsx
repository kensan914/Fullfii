    ...
    <>
      ...
      >
        <Block style={styles.modalInnerContainer}>
          <Block style={styles.titleContainer}>
            <Text bold size={20} color={COLORS.BLACK}>Fullfiiを応援する</Text>
          </Block>
          ...
          <Block style={styles.descriptionContainer}>
            <Text size={13} color={COLORS.BLACK} style={styles.lineHeight}>いつもご利用ありがとうございます！Fullfiiを気に入っていただけましたらぜひ5つ星評価をお願いします！</Text>
          </Block>
          <Button color='transparent' shadowless={true} opacity={0.6} style={styles.dissatisfactionButton} onPress={onPressDissatisfaction}>
            <Text size={16} color={COLORS.BROWN}>
              不満がある
            </Text>
          </Button>
          <Block row>
            <Button color={COLORS.WHITE} shadowless={true} opacity={0.4} style={styles.cancelButton} onPress={onCancelReview}>
              <Text size={16} bold color={COLORS.BLACK}>
              キャンセル
              </Text>
            </Button>
            <Button color='transparent' shadowless={true} opacity={0.4} style={styles.reviewButton} onPress={onPressReview}>
              <Text size={16} bold color={COLORS.BLACK}>
              レビューする
              </Text>
            </Button>
      ...
      >
        <TouchableOpacity activeOpacity={1} onPress={dismissKeyboard}>
          <Block style={styles.modalInnerContainer}>
            <Block style={styles.titleContainer}>
              <Text bold size={20} color={COLORS.BLACK}>不満点を聞かせてください</Text>
            </Block>
            <Block style={styles.descriptionDissatisfactionContainer}>
              <Text size={13} color={COLORS.BLACK} style={styles.lineHeight}>サービスの体験向上のために使いづらい点を教えていただきたいです！</Text>
            </Block>
              <TextInput
                multiline
                numberOfLines={4}
              ...
              />
            <Block row>
              <Button color={COLORS.WHITE} shadowless={true} opacity={0.4} style={styles.cancelButton} onPress={onCancelDissatisfaction}>
                <Text size={16} bold color={COLORS.BLACK}>
                キャンセル
                </Text>
              </Button>
              <Button color='transparent' shadowless={true} opacity={0.4} style={styles.reviewButton} onPress={onSubmitDissatisfaction}>
                <Text size={16} bold color={COLORS.BLACK}>
                送信
                </Text>
              </Button>
