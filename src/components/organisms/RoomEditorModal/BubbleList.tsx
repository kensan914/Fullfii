...
import { BubbleItems, BubbleItem, PressBubble } from "src/types/Types";
...
export const BubbleList: React.FC<BubbleListProps> = (props) => {
  ...
  const shouldShiftRow = (rowIndex: number) => {
    // 列数が偶数であれば奇数列をずらす. 逆もしかり.
    if (limitLines % 2 === 0) {
      return rowIndex % 2 !== 0;
    } else {
      return rowIndex % 2 === 0;
  ...
  return (
    <ScrollView
      ...
      style={[styles.bubbleListScrollView, style]}
